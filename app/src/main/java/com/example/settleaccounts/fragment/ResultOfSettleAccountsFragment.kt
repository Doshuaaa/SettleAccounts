 ...
 * Use the [ResultOfSettleAccountsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ResultOfSettleAccountsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ResultOfSettleAccountsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ResultOfSettleAccountsFragment().apply {
